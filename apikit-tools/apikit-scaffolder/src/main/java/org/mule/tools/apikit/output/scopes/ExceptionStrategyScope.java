...
public class ExceptionStrategyScope implements Scope {
    ...
    public ExceptionStrategyScope(Boolean useApikitExceptionStrategy, String apiId) {
        ...
        if (useApikitExceptionStrategy)
        {
            apikitExceptionStrategy(apiId, statusCodeMappings);
        }
        else
        {
    ...
    private void apikitExceptionStrategy(String apiId, List<StatusCodeMapping> statusCodeMappings)
    {
