...
public class MuleDomainParserTest
{
    ...
    public void testCustomDomain() {
        ...
        Map<String, IHttpListenerConfig> httpListenerConfigs = muleDomainParser.getHttpListenerConfigs();
        assertNotNull(httpListenerConfigs);
        assertEquals(1, httpListenerConfigs.size());
        String expectedKey = "http-lc-0.0.0.0-8081";
        IHttpListenerConfig value = httpListenerConfigs.get(expectedKey);
    ...
    public void testMultipleLCInDomain() {
        ...
        IHttpListenerConfig value2 = httpListenerConfigs.get(expectedKey2);
        ...
        IHttpListenerConfig value3 = httpListenerConfigs.get(expectedKey3);
        ...
        IHttpListenerConfig value4 = httpListenerConfigs.get(expectedKey4);
